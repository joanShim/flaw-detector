...
export default function LandingHeroSection({
  ...
  return (
    <section
      className="flex-center-center snap-box relative min-h-[calc(100dvh-8.5rem)] flex-col items-center text-[3.75rem] leading-[4.538rem] tracking-[0.015em] text-primary-500"
      id="hero"
    >
      ...
      <p className="word-break-phrase mb-[4rem] text-center text-[1.5rem]">
